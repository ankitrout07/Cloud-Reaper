...
class CrossCloudPolicyEngine:
                ...
                "gcp": [
                    {
                        ...
                        "parameters": {"constraint": "compute.vmCanIpmi", "policyType": "boolean"},
                    }
                ],
            },
        )
    ...
    def update_template(self, policy_id: str, updates: dict[str, Any]) -> dict[str, Any]:
        ...
        if not template:
            return {"success": False, "error": f"Policy template '{policy_id}' not found"}
    ...
    def delete_template(self, policy_id: str) -> dict[str, Any]:
        ...
        return {"success": True, "message": f"Policy template '{policy_id}' deleted successfully"}
    ...
    def evaluate_policy_compliance(
        ...
        if not provider_rules:
            return {"success": False, "error": f"No rules defined for provider '{provider}'"}
