...
class RealtimeRefreshService:
    ...
    def register_refresh_task(
        ...
        logger.info(f"Registered refresh task: {task_id} (interval: {interval or self.refresh_interval}s)")
    ...
    async def refresh_task(self, task_id: str) -> Optional[Any]:
        """
        ...
        while not self._stop_event.is_set():
            ...
            for task_id, task in self.refresh_tasks.items():
                ...
                if task["last_refresh"] is None:
                    ...
                    elapsed = (datetime.now(timezone.utc) - task["last_refresh"]).total_seconds()
    ...
    def get_all_status(self) -> dict[str, dict[str, Any]]:
        ...
        return {
            ...
            for task_id in self.refresh_tasks
        }
