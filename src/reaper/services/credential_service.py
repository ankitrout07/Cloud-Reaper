...
class CredentialService:
    ...
    def validate_credentials(self, provider: str) -> dict[str, Any]:
        ...
        try:
            ...
            return {"valid": False, "message": f"Unknown provider: {provider}", "details": ""}
        except Exception as e:
            logger.error(f"Credential validation failed for {provider}: {e}")
            return {"valid": False, "message": f"Validation failed: {e!s}", "details": ""}
    ...
    def _validate_azure(self, credentials: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {"valid": False, "message": f"Azure connection failed: {e!s}", "details": ""}
    ...
    def _validate_gcp(self, credentials: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {"valid": False, "message": f"GCP validation failed: {e!s}", "details": ""}
...
def require_credentials(provider: str | None = None) -> dict[str, Any]:
    """
