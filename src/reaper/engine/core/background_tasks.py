...
try:
    from reaper.integrations.go_task_manager import GoTaskManagerBridge, get_task_manager_bridge
    from reaper.integrations.go_task_manager import TaskStatus as GoTaskStatus
