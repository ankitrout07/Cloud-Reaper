...
class AIBackendManager:
    ...
    def _determine_backend(self) -> str:
        ...
        # Validate backend choice — only cloud APIs are supported
    ...
    def _initialize_backends(self):
        """Initialize the selected cloud AI backend."""
        # Cloud API backends are initialised lazily by the individual engine classes
        # that hold the API client — nothing to do here.
        pass
