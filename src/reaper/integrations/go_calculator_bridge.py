...
class CalculatorBridge(BaseGoBridge):
    ...
    def __init__(
        self, host: str = "localhost", port: int = 7075, timeout: float = 30.0, enabled: bool = True
    ):
        """
    ...
    async def calculate_monthly_cost(
        self, provider: str, resource_type: str, sku: str, quantity: float = 1.0
    ) -> dict[str, Any]:
        """
    ...
    async def calculate_total_hourly_burn(self, items: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        """
        return await self._make_request(
            "POST", "/api/calculator/total_burn", json_data={"items": items}
        )
    ...
    async def batch_calculate_monthly_cost(self, items: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        """
        return await self._make_request(
            "POST", "/api/calculator/batch_monthly", json_data={"items": items}
        )
    ...
    async def batch_calculate_hourly_cost(self, items: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        """
        return await self._make_request(
            "POST", "/api/calculator/batch_hourly", json_data={"items": items}
        )

    async def update_price(
        self, provider: str, resource_type: str, sku: str, rate: float
    ) -> dict[str, Any]:
        """
    ...
    async def load_price_book(self, price_book_data: dict[str, Any]) -> dict[str, Any]:
        ...
        """
        return await self._make_request(
            "POST", "/api/calculator/load_pricebook", json_data=price_book_data
        )
    ...
    async def set_currency(self, currency: str) -> dict[str, Any]:
        ...
        """
        return await self._make_request(
            "POST", "/api/calculator/set_currency", json_data={"currency": currency}
        )
...
def create_calculator_bridge(**kwargs) -> CalculatorBridge:
    ...
    """
    return create_bridge_client(CalculatorBridge, "calculator", **kwargs)


# Global singleton instance
_global_calculator_bridge: CalculatorBridge | None = None
