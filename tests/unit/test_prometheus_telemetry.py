...
class TestPrometheusTelemetry(unittest.TestCase):
    ...
    def test_fetch_node_avg_cpu_utilization(self, mock_get):
        ...
        mock_response.json.return_value = {
            ...
            "data": {
                ...
                "result": [
                    {
                        "metric": {"instance": "10.0.1.4"},
                        "value": [1779285600, "8.5"]
                    },
                    {
                        "metric": {"instance": "10.0.1.5"},
                        "value": [1779285600, "50.2"]
                    }
                ]
            }
        }
    ...
    @patch('reaper.collectors.prometheus_finops.PrometheusFinOpsCollector.fetch_node_avg_cpu_utilization')
