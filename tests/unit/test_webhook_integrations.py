...
def test_update_integrations_settings(client):
    ...
    assert settings_state["slack_webhook_url"] == "https://hooks.slack.com/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX"
...
def test_test_webhook_endpoint_invalid_platform(client):
    payload = {
        ...
        "webhook_url": "https://unknown.com/services/test"
    }
...
def test_test_webhook_endpoint_invalid_url(client):
    payload = {
        "platform": "slack",
        "webhook_url": "ftp://hooks.slack.com/services/test"
    }
