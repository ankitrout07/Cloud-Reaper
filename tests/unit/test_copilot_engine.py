...
from reaper.engine.copilot_engine import KnapsackCopilotEngine, DOWNGRADE_PATHS
from reaper.engine.copilot_schemas import OptimizationBlueprintSchema, ItemizedComponent
...
def test_scale_down_correction_loop(mock_client_cls, mock_gemini_env):
    ...
    initial_hcl = 'resource "azurerm_virtual_machine" "vm" {\n  count = 2\n  size = "Standard_D4s_v5"\n}'
